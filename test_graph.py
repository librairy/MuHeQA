...
import application.summary.kg.wikipedia as kg_wiki
import unidecode
...
def test_2():
	...
	wiki = kg_wiki.Wikipedia()
	wiki_resources = wiki.find_resources(keyword)
	print("Wikipedia Candidates: ")
	for r in wiki_resources:
		print("\t ",r['label'],"-",r['description'])
	print("Top Resources:")
	top_wiki_resources = graph.get_top_resources(query,keyword,wiki_resources,3,True,False,False)
	for r in top_wiki_resources:
		print("\t ",r['label'],"-",r['description'],"-",r['score'])
